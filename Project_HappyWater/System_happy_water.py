...
def homepageA() : 
                                    ...
                                    if birth:
                                        if ph1:
                                            if ph1.isdigit():
                                                ...
                                                result = cursor.fetchall()
                                                if result:
                                                    messagebox.showwarning("System","มีบัตรประชาชนนี้ในฐานข้อมูลแล้ว") 
                                                else:
                                                    try:
                                                        int_newID = int(newID)
                                                        if len(newID) < 13:         
    ...
    def manage_product() :
        ...
        def addBtn() :
            ...
            ans = messagebox.askquestion("System", "คุณแน่ใจหรือว่าจะเพิ่มจำนวนสินค้า ?")     
            if ans == 'yes' :
                if new_amt:
                    try:
                        ckint = int(new_amt)
    ...
    def manage_agent() : 
        ...
        agentTable.heading('col1', text="รหัสซัพพลายเออร์", anchor=W)
    ...
    def manage_MatPur() :
        ...
        def deleteMP() : 
            ans = messagebox.askquestion("System", "คุณแน่ใจว่าต้องการลบรายการสั่งซื้อวัตถุดิบนี้ ?")
    ...
    def order_report() :
        ...
        Label(mngFrame1,text="เดือนที่ต้องการสรุปยอด",font="Calibri 16 bold",bg="#e0f2fc").place(x=195,y=100)
...
def homepageS() : 
    ...
    def payment() : 
        ...
        payproof = Button(mngFrame1,text="ส่งหลักฐานการชำระเงิน",bg='#00D100',command=send_payment_proof)
